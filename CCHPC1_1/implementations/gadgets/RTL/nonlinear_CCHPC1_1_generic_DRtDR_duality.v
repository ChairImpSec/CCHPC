...
module nonlinear_CCHPC1_1_generic_DRtDR_duality #(
    ...
    clk, prch0, prch1, a_layer0, a_duality0, a_duality1, b_layer0, b_duality0, b_duality1, r_SR, r_duality0, r_duality1, z_layer0, z_duality0, z_duality1
);
    ...
    input [RAIL_FACTOR*RAND_COUNT_CONSEC_SAFE-1:0] r_duality0; 	// externally pre-charged dual-rail random bits aligned with duality instance 0
    input [RAIL_FACTOR*RAND_COUNT_CONSEC_SAFE-1:0] r_duality1; 	// externally pre-charged dual-rail random bits aligned with duality instance 1
        ...
        if (FORWARD_R == 1) begin : gen_forward_outputs_
            ...
            for (zl = 1; zl < d-1; zl=zl+1) begin : gen_layer_
                ...
                DRP_XOR2_TREE #(
                    ...
                    .a(r_duality0[2*(RAND_OFFSET+RAND_COUNT)-1:2*RAND_OFFSET]),
                ...
                DRP_XOR2_TREE #(
                    ...
                    .a(r_duality1[2*(RAND_OFFSET+RAND_COUNT)-1:2*RAND_OFFSET]),
