...
module nonlinear_CCHPC1_1_generic_DRtDR_duality_wRandCONV_wPRCHn #(
    ...
    clk, prch0, prch1, prch0_n, prch1_n, a_layer0, a_duality0, a_duality1, b_layer0, b_duality0, b_duality1, r_SR, z_layer0, z_duality0, z_duality1
);
    ...
    wire [RAIL_FACTOR*RAND_COUNT_CONSEC_SAFE-1:0]   randConsec_DR0;   // registered and pre-charged dual-rail for duality instance 0
    wire [RAIL_FACTOR*RAND_COUNT_CONSEC_SAFE-1:0]   randConsec_DR1;   // registered and pre-charged dual-rail for duality instance 1
...
//    endgenerate
    ...
    generate
        ...
        for (rpl = 1; rpl < d; rpl = rpl+1) begin : gen_randPrecomp_layer_
            ...
            for (rpk = 0; rpk < rpl; rpk = rpk+1) begin : gen_randPrecomp_rand_
                ...
                if (rpk == 0) begin : gen_rand_from_SR_
                    ...
                    // The random bit is converted and precharged separately for both
                    ...
                    NOR2 merge_rand_inst (
                        .a(randConsec_DR0[2*RAND_POS+1]),
                        .b(randConsec_DR1[2*RAND_POS+1]),
                        .z(randPrecomp[R_IDX])
                    );
        ...
        if (RAND_COUNT_CONSEC > 0) begin : gen_randConsec_
            ...
            if (OPT_PRCH == 1) begin : gen_opt_prch_
                ...
                for (rp = 1; rp < (d-1); rp=rp+1) begin : gen_layer_
                    ...
                    REG_prch_SRtDR #(
                        ...
                        .z      (randConsec_DR0[2*(RAND_OFFSET+RAND_COUNT_DRP_LAYER)-1:2*RAND_OFFSET])
                    );
                    ...
                    REG_prch_SRtDR #(
                        ...
                        .prch_n (prch1_n[rp-1]),
                        .a      (randConsec[RAND_OFFSET+RAND_COUNT_DRP_LAYER-1:RAND_OFFSET]),
                        .z      (randConsec_DR1[2*(RAND_OFFSET+RAND_COUNT_DRP_LAYER)-1:2*RAND_OFFSET])
                    );
            ...
            wire unused_randConsec;
            assign unused_randConsec = randConsec;

            assign randConsec_DR0 = {RAIL_FACTOR{1'b0}};
            assign randConsec_DR1 = {RAIL_FACTOR{1'b0}};
    ...
    nonlinear_CCHPC1_1_generic_DRtDR_duality_consecutive #(
        ...
        .bDR0(bDR0),
        .bDR1(bDR1),
        .r_DR0(randConsec_DR0),
        .r_DR1(randConsec_DR1),
        .t_DR0(t_DR0),
        .t_DR1(t_DR1),
        .t_fwd_SR0(t_fwd_SR0),
        .t_fwd_SR1(t_fwd_SR1),
