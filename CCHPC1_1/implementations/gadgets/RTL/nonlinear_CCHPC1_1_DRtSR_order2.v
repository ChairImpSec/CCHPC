module nonlinear_CCHPC1_1_DRtSR_order2 #( parameter CONF = 2'b00, aINV = 1'b0, bINV = 1'b0, zINV = 1'b0
                                       // 2'b00: and
                                       // 2'b01: nand
                                       // 2'b10: nor
                                       // 2'b11: or
    ...
    wire [7:0] t_in_layer2;
    wire [3:0] t_out_layer1;
    wire [7:0] t_out_layer2;
    ...
    // select
    op_opt op_f_inst10 (.a(in_a[2:1]), .b(in_b[2:1]), .t_out(t_out_layer1[3:0]), .z(tmp10));
