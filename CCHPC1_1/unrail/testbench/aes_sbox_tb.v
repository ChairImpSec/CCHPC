`timescale 1ns / 1ps
//////////////////////////////////////////////////////////////////////////////////
// Company: Technische Universität Darmstadt, Chair of Implementation Security
// Engineer: Lukas Weber
// 
// Create Date: 03/25/2026 06:08:53 PM
// Design Name: 
// Module Name: sbox_tb
// Project Name: 
// Target Devices: 
// Tool Versions: 
// Description: AES SBox Testbench to verify unrail tool output
// 
// Dependencies: unrail output with unrail default test definitions (no_aoi.v)
// 
// Revision:
...
module sbox_tb();
    ...
    parameter integer random_bit_count = 34;
    parameter integer disable_f2b = 0;
    parameter integer disable_b2f = 0;
    ...
    wire [7:0] diff;
    wire round_pass;
    wire [8*(1+disable_f2b)*(d-disable_f2b)-1:0] dut_stretched_input;
    wire [8*(1+disable_b2f)*(d-disable_f2b)-1:0] dut_stretched_output;
    wire clk = 0;
    wire prch = 0;
    wire [(2*(d*(d-1))/2)*random_bit_count-1:0] dut_randomness = 0;

    integer i;

    reg [7:0] sbox [0:255];

    assign diff = dut_output ^ expected_output;
    assign round_pass = ~(|diff);

    assign dut_stretched_input[0*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)] = test_input[7];
    assign dut_stretched_input[1*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)] = test_input[6];
    assign dut_stretched_input[2*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)] = test_input[5];
    assign dut_stretched_input[3*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)] = test_input[4];
    assign dut_stretched_input[4*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)] = test_input[3];
    assign dut_stretched_input[5*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)] = test_input[2];
    assign dut_stretched_input[6*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)] = test_input[1];
    assign dut_stretched_input[7*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)] = test_input[0];

    assign dut_output[7] = dut_stretched_output[0*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)];
    assign dut_output[6] = dut_stretched_output[1*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)];
    assign dut_output[5] = dut_stretched_output[2*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)];
    assign dut_output[4] = dut_stretched_output[3*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)];
    assign dut_output[3] = dut_stretched_output[4*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)];
    assign dut_output[2] = dut_stretched_output[5*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)];
    assign dut_output[1] = dut_stretched_output[6*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)];
    assign dut_output[0] = dut_stretched_output[7*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)];

    //unrail_module #(.security_order(security_order)) dut (dut_stretched_input, clk, prch, dut_randomness, dut_stretched_output);
    unrail_module #(
        .security_order(security_order)
    ) dut (
        dut_stretched_input[1*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)-1 : 0*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)],
        dut_stretched_input[2*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)-1 : 1*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)],
        dut_stretched_input[3*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)-1 : 2*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)],
        dut_stretched_input[4*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)-1 : 3*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)],
        dut_stretched_input[5*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)-1 : 4*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)],
        dut_stretched_input[6*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)-1 : 5*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)],
        dut_stretched_input[7*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)-1 : 6*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)],
        dut_stretched_input[8*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)-1 : 7*((1+disable_f2b)*(d-disable_f2b)+disable_f2b)],
        clk,
        prch,
        dut_randomness,
        dut_stretched_output[1*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)-1 : 0*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)],
        dut_stretched_output[2*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)-1 : 1*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)],
        dut_stretched_output[3*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)-1 : 2*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)],
        dut_stretched_output[4*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)-1 : 3*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)],
        dut_stretched_output[5*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)-1 : 4*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)],
        dut_stretched_output[6*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)-1 : 5*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)],
        dut_stretched_output[7*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)-1 : 6*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)],
        dut_stretched_output[8*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)-1 : 7*((1+disable_b2f)*(d-disable_b2f)+disable_b2f)]
    );
    ...
    initial begin
        ...
        $display("\n=== Start Testbench ===");
        $monitor("time=%3d, input=%h, output=%h, expected=%h, pass=%b",
                  $time, test_input, dut_output, expected_output, round_pass);

        for (i = 0; i <= 255; i = i + 1) begin
            test_input = i[7:0];
            expected_output = sbox[i[7:0]];
            #1;
            pass = pass & round_pass;
        end

        $display("=== End Testbench with pass=%b ===\n", pass);
        $finish;
    end
