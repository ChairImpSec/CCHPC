...
module nonlinear_CCHPC1_1_generic_DRtDR ( clk, prch, a, b, r_SR, r_DR, z );
  ...
  output [2:0] z;
  input clk;
  wire   nonlinear_layer0_a0nandb0;
  wire   [7:0] gen_layer__1__gen_default__gen_default_prch__t_DR_in;
  wire   [7:0] t_DR;
...
;
  ...
  XNOR2_X1 nonlinear_layer0_gen_out__xor2_inst_U1 ( .A(
        nonlinear_layer0_a0nandb0), .B(r_SR[0]), .ZN(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[4]) );
  XOR2_X1 nonlinear_precomp_gen_precomp_layer__1__gen_precomp_mtg__0__mtg_inst_xor2_inst1_U1 ( 
        .A(a[0]), .B(gen_layer__1__gen_default__gen_default_prch__t_DR_in[4]), 
        .Z(gen_layer__1__gen_default__gen_default_prch__t_DR_in[5]) );
  XOR2_X1 nonlinear_precomp_gen_precomp_layer__1__gen_precomp_mtg__0__mtg_inst_xor2_inst2_U1 ( 
        .A(b[0]), .B(gen_layer__1__gen_default__gen_default_prch__t_DR_in[4]), 
        .Z(gen_layer__1__gen_default__gen_default_prch__t_DR_in[6]) );
  XNOR2_X1 nonlinear_precomp_gen_precomp_layer__1__gen_precomp_mtg__0__mtg_inst_following_mtg_instance__xor2_inst3_U1 ( 
        .A(b[0]), .B(gen_layer__1__gen_default__gen_default_prch__t_DR_in[5]), 
        .ZN(gen_layer__1__gen_default__gen_default_prch__t_DR_in[7]) );
  INV_X1 gen_layer__1__gen_default__gen_default_prch__t_SRtDR_inst_U4 ( .A(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[4]), .ZN(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[0]) );
  INV_X1 gen_layer__1__gen_default__gen_default_prch__t_SRtDR_inst_U1 ( .A(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[7]), .ZN(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[3]) );
  INV_X1 gen_layer__1__gen_default__gen_default_prch__t_SRtDR_inst_U2 ( .A(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[6]), .ZN(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[2]) );
  INV_X1 gen_layer__1__gen_default__gen_default_prch__t_SRtDR_inst_U3 ( .A(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[5]), .ZN(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[1]) );
  NOR2_X1 gen_layer__1__gen_default__gen_default_prch__reg_t_inst_ctrl_inst_loop_gen_prch__0__ctrl_prch_inst_U1 ( 
        .A1(prch[0]), .A2(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[0]), .ZN(
  ...
  NOR2_X1 gen_layer__1__gen_default__gen_default_prch__reg_t_inst_ctrl_inst_loop_gen_prch__1__ctrl_prch_inst_U1 ( 
        .A1(prch[0]), .A2(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[1]), .ZN(
  ...
  NOR2_X1 gen_layer__1__gen_default__gen_default_prch__reg_t_inst_ctrl_inst_loop_gen_prch__2__ctrl_prch_inst_U1 ( 
        .A1(prch[0]), .A2(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[2]), .ZN(
  ...
  NOR2_X1 gen_layer__1__gen_default__gen_default_prch__reg_t_inst_ctrl_inst_loop_gen_prch__3__ctrl_prch_inst_U1 ( 
        .A1(prch[0]), .A2(
        gen_layer__1__gen_default__gen_default_prch__t_DR_in[3]), .ZN(
